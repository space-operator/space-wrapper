...
#[derive(Accounts)]
pub struct ProxyUpdateMetadataV2<'info> {
    #[account(
...
pub fn process_proxy_update_metadata_v2(
    ctx: Context<ProxyUpdateMetadataV2>,
    name: String,
    symbol: String,
    uri: String,
    ...
    let update_metadata_accounts_v2_instruction = update_metadata_accounts_v2(
        program_id,
        metadata.key(),
        update_authority,
